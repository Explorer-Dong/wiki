...
仓库 (Registry) 是集中存放镜像的地方，用来分发和管理各个用户或组织上传的镜像，类似于 [GitHub](../tools/git/github.md) 之于代码、应用商店之于软件。最常用的是 [Docker Hub](https://hub.docker.com/) 官方仓库，企业也可以搭建私有仓库来存放内部的镜像。
